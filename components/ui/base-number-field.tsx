...
const inputVariants = cva(
  [
    'border border-input flex items-center justify-center transition-colors select-none disabled:opacity-50 disabled:pointer-events-none w-8 text-center',
      ...
      >
        ...
        <NumberFieldPrimitive.Group className="shadow-xs shadow-black/5 text-foreground flex rounded-md transition-shadow">
          <NumberFieldPrimitive.Decrement
            className={cn(buttonVariants({ size }), 'rounded-s-sm border-e-0')}
          ...
          <NumberFieldPrimitive.Increment
            className={cn(buttonVariants({ size }), 'rounded-e-sm border-s-0')}
