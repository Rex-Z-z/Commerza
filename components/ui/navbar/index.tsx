        ...
        <div className="flex flex-row gap-4">
          ...
          >
            ...
            >
              ...
              ></path>
              <path
                d="M10.7143 40H4.28571C1.91878 40 0 38.0812 0 35.7143V29.2857L10.7143 40Z"
                fill="white"
              ></path>
              <path
              ...
              ></path>
              <path
                d="M244.136 6.92919C252.576 6.92919 259.448 13.8007 259.448 22.2407V33.0708H251.979V22.2407C251.979 19.1411 250.112 16.4522 247.497 15.1825V33.0708H240.028V22.2407C240.028 19.1411 238.161 16.4522 235.547 15.1825V33.0708H228.078V6.92919H232.186C235.024 6.92919 237.713 7.75078 240.028 9.13256V6.92919H244.136Z"
                fill="white"
              ></path>
              <path
                d="M225.111 22.2407C225.111 28.2159 220.219 33.0708 214.281 33.0708C208.306 33.0708 203.451 28.2159 203.451 22.2407V6.92919H210.92V22.2407C210.92 24.108 212.414 25.6018 214.281 25.6018C216.111 25.6018 217.642 24.108 217.642 22.2407V6.92919H225.111V22.2407Z"
                fill="white"
              ></path>
              <path
                d="M201.174 24.6681C201.174 29.2616 197.439 32.9961 192.846 32.9961H181.754V25.5271H192.846C193.294 25.5271 193.705 25.1536 193.705 24.6681C193.705 24.22 193.294 23.8466 192.846 23.8466H189.821C185.153 23.8466 181.381 20.0747 181.381 15.4065C181.381 10.7384 185.153 6.92919 189.821 6.92919H200.8V14.3982H189.821C189.261 14.3982 188.85 14.8464 188.85 15.4065C188.85 15.9294 189.261 16.3775 189.821 16.3775H192.846C197.439 16.3775 201.174 20.112 201.174 24.6681Z"
                fill="white"
              ></path>
              <path
                d="M170.441 6.92919C175.669 6.92919 179.964 11.2239 179.964 16.4522C179.964 21.7179 175.669 25.9752 170.441 25.9752H167.64V33.0708H160.171V6.92919H170.441ZM170.441 18.5062C171.561 18.5062 172.495 17.6099 172.495 16.4522C172.495 15.3319 171.561 14.3982 170.441 14.3982H167.64V18.5062H170.441Z"
                fill="white"
              ></path>
              <path
                d="M156.809 33.0708H149.34V6.92919H156.809V33.0708Z"
                fill="white"
              ></path>
              <path
                d="M147.046 20C147.046 27.2076 141.145 33.0708 133.975 33.0708C126.767 33.0708 120.904 27.2076 120.904 20C120.904 12.8297 126.767 6.92919 133.975 6.92919C141.145 6.92919 147.046 12.8297 147.046 20ZM139.577 20C139.577 16.9377 137.037 14.3982 133.975 14.3982C130.875 14.3982 128.373 16.9377 128.373 20C128.373 23.0996 130.875 25.6018 133.975 25.6018C137.037 25.6018 139.577 23.0996 139.577 20Z"
                fill="white"
              ></path>
              <path
                d="M118.73 18.3195V33.0708H109.394C102.187 33.0708 96.3233 27.2076 96.3233 20C96.3233 12.8297 102.187 6.92919 109.394 6.92919H118.73V14.3982H109.394C106.295 14.3982 103.792 16.9377 103.792 20C103.792 23.0996 106.295 25.6018 109.394 25.6018H111.261V18.3195H118.73Z"
                fill="white"
              ></path>
              <path
                d="M95.1126 20C95.1126 27.2076 89.212 33.0708 82.0417 33.0708C74.8341 33.0708 68.9709 27.2076 68.9709 20C68.9709 12.8297 74.8341 6.92919 82.0417 6.92919C89.212 6.92919 95.1126 12.8297 95.1126 20ZM87.6435 20C87.6435 16.9377 85.1041 14.3982 82.0417 14.3982C78.9421 14.3982 76.44 16.9377 76.44 20C76.44 23.0996 78.9421 25.6018 82.0417 25.6018C85.1041 25.6018 87.6435 23.0996 87.6435 20Z"
                fill="white"
              ></path>
              <path
                d="M68.2013 25.6018V33.0708H58.865C55.1305 33.0708 52.1429 30.0832 52.1429 26.3487V6.92919H59.6119V25.6018H68.2013Z"
                fill="white"
              ></path>
            </svg>
          </a>
        ...
        {page !== "dashboard" && (
          <div
            className={cn(
              ...
              isScrolledPastSearch || isSearchPage
          ...
          >
            ...
            <Button
              variant="secondary"
              size="lg"
              className="rounded-full hover:text-primary/90 hover:bg-gray-100"
            >
