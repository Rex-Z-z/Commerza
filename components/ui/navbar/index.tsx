...
import { MapPin, Store, ShoppingBasket, MessageCircleQuestionMark, Menu, SidebarIcon  } from "lucide-react"
...
const NavBar = ({ page = 'default' }: { page?: 'default' | 'search' | 'dashboard' }) => {
    ...
    return (
        <div className={cn(`flex flex-col bg-[#35B9EC] border-b border-transparent sticky top-0 z-20`, 
            ...
            <div className={cn(`block px-4`, isScrolled ? "opacity-0 -translate-y-4" : "opacity-100 translate-y-0", page === 'dashboard' && "hidden")} >
