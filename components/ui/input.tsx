...
const inputVariants = cva(
  `
    flex w-full bg-transparent dark:bg-input/30 border-2 border-input shadow-xs shadow-black/5 transition-[color,box-shadow] text-foreground placeholder:text-muted-foreground
    selection:bg-primary selection:text-primary-foreground
    focus-visible:border-primary focus-visible:ring-primary/50 focus-visible:outline-none focus-visible:ring-[3px]     
